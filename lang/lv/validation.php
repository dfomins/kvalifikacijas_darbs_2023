...
return [
    ...
    "are_you_sure_you_want_to_delete_member" => "Vai tiešām vēlaties noņemt šo komandas dalībnieku?",
    "are_you_sure_you_want_to_delete_team" => "Vai tiešām vēlaties dzēst šo komandu?",
    "are_you_sure_you_want_to_leave_team" => "Vai tiešām vēlaties pamest šo komandu?",
    ...
    "attributes.team" => "komanda",
    "before" => ":Attribute ir jābūt ar datumu pirms :date.",
    "before_or_equal" => ":Attribute ir jābūt ar datumu pirms vai vienādu ar :date.",
    "between.array" => ":Attribute jābūt no :min līdz :max vienībām.",
    "between.file" => ":Attribute jābūt starp :min un :max kilobaitiem.",
    "between.numeric" => ":Attribute jābūt starp :min un :max.",
    "between.string" => ":Attribute jābūt no :min līdz :max zīmēm.",
    "boolean" => ":Attribute lauciņam jābūt patiesam vai nepatiesam.",
    "confirmed" => ":Attribute apstiprinājums neatbilst.",
    "country" => "Lauks :attribute nav derīga valsts.",
    "create_team" => "Izveidot komandu",
    "current_password" => "Parole ir nepareiza.",
    "current_teams" => "Pašreizējās komandas",
    ...
    "edit_team_member" => "Rediģēt komandas dalībnieku",
    ...
    "gt.array" => ":Attribute jābūt vairāk nekā :value vienībām.",
    "gt.file" => ":Attribute jābūt lielākam par :value kilobaitiem.",
    "gt.numeric" => ":Attribute jābūt lielākam par :value.",
    "gt.string" => ":Attribute jāpārsniedz :value rakstzīmes.",
    "gte.array" => ":Attribute jābūt :value vai vairāk vienībām.",
    "gte.file" => ":Attribute jābūt lielākam vai vienādam ar :value kilobaitiem.",
    "gte.numeric" => ":Attribute jābūt lielākam vai vienādam ar :value.",
    "gte.string" => ":Attribute garumam jābūt lielākam vai vienādam ar :value rakstzīmēm.",
    "if_you_delete_team_all_data_will_be_deleted" => "Ja izvēlaties dzēst komandu, visi dati tiks neatgriezeniski dzēsti.",
    ...
    "looks_like_you_are_not_part_of_team" => "Izskatās, ka tu neesi nevienas komandas sastāvā!",
    "lowercase" => ":Attribute ir jābūt mazajiem burtiem.",
    "lt.array" => ":Attribute jābūt mazāk nekā :value vienībām.",
    "lt.file" => ":Attribute nedrīkst pārsniegt :value kilobaitus.",
    "lt.numeric" => ":Attribute jābūt mazākam nekā :value.",
    "lt.string" => ":Attribute nedrīkst pārsniegt :value rakstzīmes.",
    "lte.array" => ":Attribute nedrīkst būt vairāk par :value vienībām.",
    "lte.file" => ":Attribute nedrīkst pārsniegt :value kilobaitus.",
    "lte.numeric" => ":Attribute jābūt mazākam vai vienādam ar :value.",
    "lte.string" => ":Attribute nedrīkst pārsniegt :value rakstzīmes.",
    "mac_address" => ":Attribute ir jābūt derīgai MAC adresei.",
    "max.array" => ":Attribute nedrīkst pārsniegt :max vienības.",
    "max.file" => ":Attribute nedrīkst pārsniegt :max kilobaitus.",
    "max.numeric" => ":Attribute nedrīkst pārsniegt :max.",
    "max.string" => ":Attribute nedrīkst pārsniegt :max rakstzīmes.",
    ...
    "min.array" => ":Attribute jāsatur vismaz :min vienības.",
    "min.file" => ":Attribute jābūt vismaz :min kilobaitiem.",
    "min.numeric" => ":Attribute jābūt vismaz :min.",
    "min.string" => ":Attribute jābūt vismaz :min rakstzīmēm.",
    ...
    "next" => "Nākamais &raquo;",
    "not_eligible_based_on_current_members_teams" => "Jūs nevarat izmantot šo plānu, pamatojoties uz jūsu pašreizējo komandu/komandas dalībnieku skaitu.",
    ...
    "password.letters" => ":Attribute ir jāsatur vismaz viens burts.",
    "password.mixed" => ":Attribute ir jāsatur vismaz viens lielais un viens mazais burts.",
    "password.numbers" => ":Attribute ir jāsatur vismaz viens skaitlis.",
    "password.symbols" => ":Attribute ir jāsatur vismaz viens simbols.",
    "password.uncompromised" => "Dotais :attribute ir parādījies datu noplūdē. Lūdzu, izvēlieties citu :attribute.",
    "plan_allows_no_more_teams" => "Jūsu pašreizējais plāns neļauj izveidot vairāk komandu",
    "please_upgrade_to_add_more_members" => "Lūdzu, jauniniet savu abonementu, lai pievienotu citus komandas dalībniekus.",
    "please_upgrade_to_create_more_teams" => "Lūdzu, jauniniet savu abonementu, lai izveidotu vairāk komandu.",
    ...
    "remove_team_member" => "Noņemt komandas locekli",
    "required" => ":Attribute ir obligāts(-a).",
    ...
    "size.array" => ":Attribute jāsatur :size vienības.",
    "size.file" => ":Attribute jābūt :size kilobaiti.",
    "size.numeric" => ":Attribute jābūt :size.",
    "size.string" => ":Attribute jābūt :size rakstzīmēm.",
    "slug_input_explanation" => "Šo sliņķi izmanto, lai identificētu jūsu komandu vietrāžos URL.",
    "starts_with" => ":Attribute jāsākas ar kādu no šiem: :values",
    "state" => "Šis stāvoklis nav derīgs norādītajai valstij.",
    "string" => ":Attribute jābūt virknē.",
    "team" => "Komanda",
    "team_billing" => "Komandas norēķini",
    "team_members" => "Komandas dalībnieki",
    "team_name" => "Komandas nosaukums",
    "team_name_was_updated" => "Jūsu komandas nosaukums ir atjaunināts!",
    "team_photo" => "Komandas foto",
    "team_profile" => "Komandas profils",
    "team_settings" => "Komandas iestatījumi",
    "team_slug" => "Komanda Slug",
    "team_trial" => "Komandas izmēģinājums",
    "team_trial_will_expire_on" => "Komandas pārbaudes laiks beigsies :date. gadā.",
    "teams" => "Komandas",
    "teams_currently_trialing" => "Komandas pašlaik piedalās izmēģinājumā",
    ...
    "update_team_name" => "Atjauniniet komandas nosaukumu",
    ...
    "user_already_invited_to_team" => "Šis lietotājs jau ir uzaicināts komandā.",
    "user_already_on_team" => "Šis lietotājs jau ir komandā.",
    "user_doesnt_belong_to_team" => "Lietotājs nepieder dotajai komandai.",
    "user_invited_to_join_team" => ":UserName uzaicināja jūs pievienoties savai komandai!",
    "uuid" => ":Attribute jābūt derīgam UUID.",
    "vat_id" => "Šis PVN identifikācijas numurs nav derīgs.",
    "view_all_teams" => "Skatīt visas komandas",
    "we_found_invitation_to_team" => "Atradām tavu ielūgumu uz :teamName komandu!",
    "wheres_your_team" => "Kur ir Tava komanda?",
    "you_have_been_invited_to_join_team" => "Jūs esat uzaicināts pievienoties :teamName komandai!",
    "you_have_x_invitations_remaining" => "Pašlaik jums ir atlikuši :count ielūgumi.",
    "you_have_x_teams_remaining" => "Pašlaik jums ir atlikušas :teamCount komandas.",
